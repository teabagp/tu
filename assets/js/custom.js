...
(function( $ ){
	...
	$('#mu-event-counter').countdown('2019/09/14').on('update.countdown', function(event) {
	  var $this = $(this).html(event.strftime(''
	    + '<span class="mu-event-counter-block"><span>%D</span> День</span> '
	    + '<span class="mu-event-counter-block"><span>%H</span> Часа</span> '
	    + '<span class="mu-event-counter-block"><span>%M</span> Минут</span> '
	    + '<span class="mu-event-counter-block"><span>%S</span> Секунд</span>'));
	});
